...
namespace CoreCT.Text
{
    ...
    public static class TextTools
    {
        ...
        public static bool IsNumber(string subject, bool noTrim = false)
        {
            ...
            {
                return ulong.TryParse(subject.Substring(2), System.Globalization.NumberStyles.AllowHexSpecifier, System.Globalization.CultureInfo.CurrentCulture, out v);
            }
            return false;
        }
