...
namespace CoreCT.Shell32.PropertyStore
{
    ...
    public sealed class PropVariant : IDisposable
    {
        ...
        private static Dictionary<Type, Action<PropVariant, Array, uint>> GenerateVectorActions()
        {
            ...
            cache.Add(typeof(decimal), (pv, array, i) =>
            {
                ...
                for (int a = 0, loopTo = val.Length - 1; a <= loopTo; a++)
                    ...
                    val[a] = Marshal.ReadInt32(pv._ptr2, (int)i * Microsoft.VisualBasic.Strings.Len(0) + a * 4);
            ...
            lock (_padlock)
            {
                ...
                if (!_cache.TryGetValue(type, out action))
                {
                    ...
                    if (constructor is null)
                    {
                        ...
                        throw new ArgumentException(Resources.LocalizedMessages.PropVariantTypeNotSupported);
                    }
                    else
                    {
        ...
        public PropVariant(string value)
        {
            if (value is null)
            {
                throw new ArgumentException(Resources.LocalizedMessages.PropVariantNullString, "value");
            }
        ...
        public PropVariant(decimal[] value)
        {
            ...
            _ptr2 = Marshal.AllocCoTaskMem(value.Length * Microsoft.VisualBasic.Strings.Len(0));
            for (int i = 0, loopTo = value.Length - 1; i <= loopTo; i++)
            {
        ...
        private Array GetVector<T>()
        {
            ...
            {
                throw new InvalidCastException(Resources.LocalizedMessages.PropVariantUnsupportedType);
            }

            Array array = new T[count];
            for (uint i = 0U, loopTo = (uint)(count - 1); i <= loopTo; i++)
                action(this, array, i);
            return array;
        }
        ...
        private static Array CrackSingleDimSafeArray(IntPtr psa)
        {
            ...
            if (cDims != 1L)
            {
                throw new ArgumentException(Resources.LocalizedMessages.PropVariantMultiDimArray, "psa");
            }
    ...
    internal sealed class PropVariantNativeMethods
    {
        ...
        internal static extern void PropVariantClear([In] PropVariant pvar);
