...
namespace DataTools.Win32Api
{
    internal static class IO
    {
        ...
        public static extern int CompareFileTime(User32.FILETIME lpFileTime1, User32.FILETIME lpFileTime2);
        ...
        public static extern IntPtr FindFirstFile([MarshalAs(UnmanagedType.LPWStr)] string lpFilename, [MarshalAs(UnmanagedType.Struct)] ref User32.WIN32_FIND_DATA lpFindFileData);
        [DllImport("kernel32", EntryPoint = "FindNextFileW", CharSet = CharSet.Unicode)]
        public static extern bool FindNextFile(IntPtr hFindFile, [MarshalAs(UnmanagedType.Struct)] ref User32.WIN32_FIND_DATA lpFindFileData);
        ...
        public static extern IntPtr FindFirstFileEx([MarshalAs(UnmanagedType.LPWStr)] string lpFilename, FINDEX_INFO_LEVELS fInfoLevelId, ref User32.WIN32_FIND_DATA lpFindFileData, FINDEX_SEARCH_OPS fSearchOp, IntPtr lpSearchFilter, int dwAdditionalFlags);
        ...
        public struct BY_HANDLE_FILE_INFORMATION
        {
            ...
            public User32.FILETIME ftCreationTimeInteger;
            [MarshalAs(UnmanagedType.Struct)]
            public User32.FILETIME ftLastAccessTimeInteger;
            [MarshalAs(UnmanagedType.Struct)]
            public User32.FILETIME ftLastWriteTimeInteger;
        ...
        [DllImport("kernel32")]
        public static extern int FileTimeToDosDateTime(ref User32.FILETIME lpFileTime, int lpFatDate, int lpFatTime);
        [DllImport("kernel32")]
        public static extern int FileTimeToLocalFileTime(ref User32.FILETIME lpFileTime, ref User32.FILETIME lpLocalFileTime);
        [DllImport("kernel32")]
        public static extern int FileTimeToSystemTime(ref User32.FILETIME lpFileTime, ref User32.SYSTEMTIME lpSystemTime);
        [DllImport("kernel32")]
        public static extern int LocalFileTimeToFileTime(ref User32.FILETIME lpLocalFileTime, ref User32.FILETIME lpFileTime);
        [DllImport("kernel32")]
        public static extern int SystemTimeToFileTime(ref User32.SYSTEMTIME lpSystemTime, ref User32.FILETIME lpFileTime);
        ...
        public static extern int pGetFileTime(IntPtr hFile, User32.FILETIME lpCreationTime, User32.FILETIME lpLastAccessTime, User32.FILETIME lpLastWriteTime);
        [DllImport("kernel32", EntryPoint = "SetFileTime")]
        public static extern int pSetFileTime(IntPtr hFile, User32.FILETIME lpCreationTime, User32.FILETIME lpLastAccessTime, User32.FILETIME lpLastWriteTime);
        [DllImport("kernel32", EntryPoint = "SetFileTime")]
        public static extern int pSetFileTime2(IntPtr hFile, ref User32.FILETIME lpCreationTime, ref User32.FILETIME lpLastAccessTime, ref User32.FILETIME lpLastWriteTime);
