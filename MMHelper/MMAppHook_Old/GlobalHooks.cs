	...
	public class GlobalHooks : NativeWindow
	{
		...
		public class CBTHook : Hook
		{
			...
			protected override void OnStart()
			{
				...
				_MsgID_CBT_HookReplaced = RegisterWindowMessage("NNM_HOOK_CBT_REPLACED");
				_MsgID_CBT_Activate = RegisterWindowMessage("NNM_HOOK_HCBT_ACTIVATE");
				_MsgID_CBT_CreateWnd = RegisterWindowMessage("NNM_HOOK_HCBT_CREATEWND");
				_MsgID_CBT_DestroyWnd = RegisterWindowMessage("NNM_HOOK_HCBT_DESTROYWND");
				_MsgID_CBT_MinMax = RegisterWindowMessage("NNM_HOOK_HCBT_MINMAX");
				_MsgID_CBT_MoveSize = RegisterWindowMessage("NNM_HOOK_HCBT_MOVESIZE");
				_MsgID_CBT_SetFocus = RegisterWindowMessage("NNM_HOOK_HCBT_SETFOCUS");
				_MsgID_CBT_SysCommand = RegisterWindowMessage("NNM_HOOK_HCBT_SYSCOMMAND");
		...
		public class ShellHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_Shell_HookReplaced = RegisterWindowMessage("NNM_HOOK_SHELL_REPLACED");
				_MsgID_Shell_ActivateShellWindow = RegisterWindowMessage("NNM_HOOK_HSHELL_ACTIVATESHELLWINDOW");
				_MsgID_Shell_GetMinRect = RegisterWindowMessage("NNM_HOOK_HSHELL_GETMINRECT");
				_MsgID_Shell_Language = RegisterWindowMessage("NNM_HOOK_HSHELL_LANGUAGE");
				_MsgID_Shell_Redraw = RegisterWindowMessage("NNM_HOOK_HSHELL_REDRAW");
				_MsgID_Shell_Taskman = RegisterWindowMessage("NNM_HOOK_HSHELL_TASKMAN");
				_MsgID_Shell_WindowActivated = RegisterWindowMessage("NNM_HOOK_HSHELL_WINDOWACTIVATED");
				_MsgID_Shell_WindowCreated = RegisterWindowMessage("NNM_HOOK_HSHELL_WINDOWCREATED");
				_MsgID_Shell_WindowDestroyed = RegisterWindowMessage("NNM_HOOK_HSHELL_WINDOWDESTROYED");
		...
		public class KeyboardHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_Keyboard = RegisterWindowMessage("NNM_HOOK_KEYBOARD");
				_MsgID_Keyboard_HookReplaced = RegisterWindowMessage("NNM_HOOK_KEYBOARD_REPLACED");
		...
		public class MouseHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_Mouse = RegisterWindowMessage("NNM_HOOK_MOUSE");
				_MsgID_Mouse_HookReplaced = RegisterWindowMessage("NNM_HOOK_MOUSE_REPLACED");
		...
		public class KeyboardLLHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_KeyboardLL = RegisterWindowMessage("NNM_HOOK_KEYBOARDLL");
				_MsgID_KeyboardLL_HookReplaced = RegisterWindowMessage("NNM_HOOK_KEYBOARDLL_REPLACED");
		...
		public class MouseLLHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_MouseLL = RegisterWindowMessage("NNM_HOOK_MOUSELL");
				_MsgID_MouseLL_HookReplaced = RegisterWindowMessage("NNM_HOOK_MOUSELL_REPLACED");
		...
		public class CallWndProcHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_CallWndProc_HookReplaced = RegisterWindowMessage("NNM_HOOK_CALLWNDPROC_REPLACED");
				_MsgID_CallWndProc = RegisterWindowMessage("NNM_HOOK_CALLWNDPROC");
				_MsgID_CallWndProc_Params = RegisterWindowMessage("NNM_HOOK_CALLWNDPROC_PARAMS");
		...
		public class GetMsgHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_GetMsg_HookReplaced = RegisterWindowMessage("NNM_HOOK_GETMSG_REPLACED");
				_MsgID_GetMsg = RegisterWindowMessage("NNM_HOOK_GETMSG");
				_MsgID_GetMsg_Params = RegisterWindowMessage("NNM_HOOK_GETMSG_PARAMS");
