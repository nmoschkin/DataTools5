...
#region Accessors
		...
		public class CBTHook : Hook
		{
			...
			protected override void OnStart()
			{
				...
				_MsgID_CBT_HookReplaced = RegisterWindowMessage(HookPrefix + "CBT_REPLACED");
				_MsgID_CBT_Activate = RegisterWindowMessage(HookPrefix + "HCBT_ACTIVATE");
				_MsgID_CBT_CreateWnd = RegisterWindowMessage(HookPrefix + "HCBT_CREATEWND");
				_MsgID_CBT_DestroyWnd = RegisterWindowMessage(HookPrefix + "HCBT_DESTROYWND");
				_MsgID_CBT_MinMax = RegisterWindowMessage(HookPrefix + "HCBT_MINMAX");
				_MsgID_CBT_MoveSize = RegisterWindowMessage(HookPrefix + "HCBT_MOVESIZE");
				_MsgID_CBT_SetFocus = RegisterWindowMessage(HookPrefix + "HCBT_SETFOCUS");
				_MsgID_CBT_SysCommand = RegisterWindowMessage(HookPrefix + "HCBT_SYSCOMMAND");
		...
		public class ShellHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_Shell_HookReplaced = RegisterWindowMessage(HookPrefix + "SHELL_REPLACED");
				_MsgID_Shell_ActivateShellWindow = RegisterWindowMessage(HookPrefix + "HSHELL_ACTIVATESHELLWINDOW");
				_MsgID_Shell_GetMinRect = RegisterWindowMessage(HookPrefix + "HSHELL_GETMINRECT");
				_MsgID_Shell_Language = RegisterWindowMessage(HookPrefix + "HSHELL_LANGUAGE");
				_MsgID_Shell_Redraw = RegisterWindowMessage(HookPrefix + "HSHELL_REDRAW");
				_MsgID_Shell_Taskman = RegisterWindowMessage(HookPrefix + "HSHELL_TASKMAN");
				_MsgID_Shell_WindowActivated = RegisterWindowMessage(HookPrefix + "HSHELL_WINDOWACTIVATED");
				_MsgID_Shell_WindowCreated = RegisterWindowMessage(HookPrefix + "HSHELL_WINDOWCREATED");
				_MsgID_Shell_WindowDestroyed = RegisterWindowMessage(HookPrefix + "HSHELL_WINDOWDESTROYED");
		...
		public class KeyboardHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_Keyboard = RegisterWindowMessage(HookPrefix + "KEYBOARD");
				_MsgID_Keyboard_HookReplaced = RegisterWindowMessage(HookPrefix + "KEYBOARD_REPLACED");
		...
		public class MouseHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_Mouse = RegisterWindowMessage(HookPrefix + "MOUSE");
				_MsgID_Mouse_HookReplaced = RegisterWindowMessage(HookPrefix + "MOUSE_REPLACED");
		...
		public class KeyboardLLHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_KeyboardLL = RegisterWindowMessage(HookPrefix + "KEYBOARDLL");
				_MsgID_KeyboardLL_HookReplaced = RegisterWindowMessage(HookPrefix + "KEYBOARDLL_REPLACED");
		...
		public class MouseLLHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_MouseLL = RegisterWindowMessage(HookPrefix + "MOUSELL");
				_MsgID_MouseLL_HookReplaced = RegisterWindowMessage(HookPrefix + "MOUSELL_REPLACED");
		...
		public class CallWndProcHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_CallWndProc_HookReplaced = RegisterWindowMessage(HookPrefix + "CALLWNDPROC_REPLACED");
				_MsgID_CallWndProc = RegisterWindowMessage(HookPrefix + "CALLWNDPROC");
				_MsgID_CallWndProc_Params = RegisterWindowMessage(HookPrefix + "CALLWNDPROC_PARAMS");
		...
		public class GetMsgHook : Hook
		{
			...
			{
				// Retreive the message IDs that we'll look for in WndProc
				_MsgID_GetMsg_HookReplaced = RegisterWindowMessage(HookPrefix + "GETMSG_REPLACED");
				_MsgID_GetMsg = RegisterWindowMessage(HookPrefix + "GETMSG");
				_MsgID_GetMsg_Params = RegisterWindowMessage(HookPrefix + "GETMSG_PARAMS");
