    ...
    public static class PInvoke
    {
        ...
        public struct FILEDESCRIPTOR
        {
            ...
            public FILEDESCRIPTOR(string name, ulong size, DateTime createDate, DateTime writeDate)
            {
                ...
                Utility.LocalToFileTime(writeDate, ref ftLastWriteTime);

                Utility.LocalToFileTime(writeDate, ref ftLastAccessTime);

                Utility.LocalToFileTime(createDate, ref ftCreationTime);
            }
            ...
            public static explicit operator FILEDESCRIPTOR(string operand)
            {
                ...
                IntPtr i;
                i = FileApi.FindFirstFile(operand, ref wf);
                if ((long)i > -1)
                {
                    FileApi.FindClose(i);
        ...
        public struct FILETIME
        {
            ...
            {
                return Utility.FileToLocal(this);
            }
            ...
            {
                return Utility.MakeLong(operand.lo, operand.hi);
            }
            ...
            public FILETIME(DateTime local) 
            {
                ...
                Utility.LocalToFileTime(local, ref tf);
        ...
        public enum DESKTOP_ACCESS_MASK
        {
            ...
            GENERIC_READ = DESKTOP_ENUMERATE | DESKTOP_READOBJECTS | FileApi.STANDARD_RIGHTS_READ,
            GENERIC_WRITE = DESKTOP_CREATEMENU | DESKTOP_CREATEWINDOW | DESKTOP_HOOKCONTROL | DESKTOP_JOURNALPLAYBACK | DESKTOP_JOURNALRECORD | DESKTOP_WRITEOBJECTS | FileApi.STANDARD_RIGHTS_WRITE,
            GENERIC_EXECUTE = DESKTOP_SWITCHDESKTOP | FileApi.STANDARD_RIGHTS_EXECUTE,
            GENERIC_ALL = DESKTOP_CREATEMENU | DESKTOP_CREATEWINDOW | DESKTOP_ENUMERATE | DESKTOP_HOOKCONTROL | DESKTOP_JOURNALPLAYBACK | DESKTOP_JOURNALRECORD | DESKTOP_READOBJECTS | DESKTOP_SWITCHDESKTOP | DESKTOP_WRITEOBJECTS | FileApi.STANDARD_RIGHTS_REQUIRED
        }
