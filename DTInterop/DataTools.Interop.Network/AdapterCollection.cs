...
namespace DataTools.Interop.Network
{
    ...
    public class NetworkAdapters : ICollection<IP_ADAPTER_ADDRESSES>, IDisposable
    {
        ...
        public Collection AdapterCollection
        {
            get
            {
                return _Col;
    ...
    public sealed class NetworkAdapter : IDisposable, INotifyPropertyChanged
    {
        ...
        internal NetworkAdapter(IP_ADAPTER_ADDRESSES nativeObject)
        {
            ...
            {
                // ' Get a WPFImage 
                _Icon = Resources.MakeWPFImage(Resources.GetItemIcon(mm, (Resources.SystemIconSizes)Conversions.ToInteger(PInvoke.SHIL_EXTRALARGE)));
                mm.Free();
                _canShowNet = true;
            }
            else
