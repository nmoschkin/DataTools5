...
namespace DataTools.Interop.Usb
{
    public static class HidFeatures
    {
        ...
        public static HIDFeatureResult GetHIDFeature(HidDeviceInfo device, int code, int datalen = 16)
        {
            ...
            IntPtr hFile;
            hFile = FileApi.CreateFile(device.DevicePath, FileApi.GENERIC_READ, FileApi.FILE_SHARE_READ | FileApi.FILE_SHARE_WRITE, IntPtr.Zero, FileApi.OPEN_EXISTING, FileApi.FILE_ATTRIBUTE_NORMAL, default);
