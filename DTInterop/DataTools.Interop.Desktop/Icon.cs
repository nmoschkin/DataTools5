...
namespace DataTools.Interop.Desktop
{
    ...
    public class IconImageEntry : IDisposable
    {
        ...
        private byte[] _makeBitmap()
        {
            ...
            CoreCT.Memory.NativeLib.Native.MemCpy(bmp, ptr1, bm.biSizeImage);
        ...
        private Icon _constructIcon()
        {
            ...
            CoreCT.Memory.NativeLib.Native.MemCpy(ptr, ppBits, bmp.biSizeImage);
            ...
            if (hasMask)
            {
                ...
                CoreCT.Memory.NativeLib.Native.MemCpy(ptr, ppBits, (long)(Math.Max(bmp.biWidth, 32) * bmp.biHeight / 8d));
            }
        ...
        {
            int sz = (int)size != 0 ? Conversions.ToInteger(size) & 0xFF : 256;
