...
namespace DataTools.SystemInformation
{
    ...
    public struct OSVERSIONINFOEX
    {
        ...
        public string szCSDVersion
        {
            get
            {
                return Conversions.ToString(szCSDVersionChar).Trim('\0');
            }
        }
        ...
        public string Name
        {
            get
            {
                ...
                if (key is object)
                {
                    string s = Conversions.ToString(key.GetValue("ProductName"));
                    key.Close();
                    return s;
                }
        ...
        public WindowsVersionConstants WindowsVersion
        {
            get
            {
                return (WindowsVersionConstants)Conversions.ToInteger(this);
            }
        }
        ...
        {
            return (WindowsVersionConstants)Conversions.ToInteger(operand.dwMajorVersion << 8 | operand.dwMinorVersion);
        }
    }
