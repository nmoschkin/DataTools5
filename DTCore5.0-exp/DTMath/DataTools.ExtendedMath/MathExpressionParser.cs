...
namespace DataTools.ExtendedMath
{
    ...
    public class MathExpressionParser
    {
        ...
        private Collection m_Col = new Collection();
        ...
        public bool ParseOperations(string value = null)
        {
            ...
            value = TextTools.OneSpace(TextTools.SpaceOperators(Strings.Trim(value)).ToLower());
            m_Expression = value;
            c = 0;
            i = value.IndexOf("(");
            if (i == -1)
            ...
            sFar = TextTools.OneSpace(TextTools.SpaceOperators(Strings.Trim(sFar)).ToLower());
        ...
        public double ParseExpression(string value, [Optional, DefaultParameterValue(null)] ref string ErrorText)
        {
            ...
            s = TextTools.Words(Strings.Trim(TextTools.OneSpace(TextTools.SpaceOperators(value))));
            ...
            try
            {
                ...
                for (j = 0; j <= loopTo1; j++)
                {
                    if (j + 3 <= n)
                    {
                        if (Information.IsNumeric(ops[j]) & Information.IsNumeric(ops[j + 1]))
                        {
                            if (ops[j + 2].ToString() == "/" & Information.IsNumeric(ops[j + 3]))
                            {
                                ops2[m] = Conversions.ToDouble(ops[j]) + Conversions.ToDouble(ops[j + 1]) / Conversions.ToDouble(ops[j + 3]);
                                m += 1;
                                j += 3;
                            }
                            ...
                            case "exp":
                                {
                                    ...
                                    m -= 1;
                                    d = Conversions.ToDouble(ops[j - 1]);
                                    e = Conversions.ToDouble(ops[j + 1]);
                                    if (d < 0.0d)
                                    {
                                        d *= -1;
                                        d = Math.Pow(d, e);
                            ...
                            case "abs":
                                {
                                    ...
                                    d = Math.Abs(Conversions.ToDouble(ops[j + 1]));
                                    ops2[m] = d;
                                    m += 1;
                                    j += 1;
                                    continue;
                            ...
                            case "sqrt":
                                {
                                    ...
                                    d = Math.Sqrt(Conversions.ToDouble(ops[j + 1]));
                                    ops2[m] = d;
                                    m += 1;
                                    j += 1;
                                    continue;
                            ...
                            case @"\":
                                {
                                    ...
                                    m -= 1;
                                    a = Conversions.ToLong(ops[j - 1]);
                                    b = Conversions.ToLong(ops[j + 1]);
                                    ops2[m] = a / b;
                                    ops[j + 1] = ops2[m];
                                    m += 1;
                                    j += 1;
                ...
                for (j = 0; j <= loopTo4; j++)
                {
                    if (Information.IsNumeric(ops[j]))
                        e += Conversions.ToDouble(ops[j]);
                }
            }
            catch (Exception ex)
            {
