...
namespace DataTools.ExtendedMath.ColorMath
{
                ...
                case '0':
                    {
                        if (chIn.Length == 1)
                            break;
                        if (chIn[1] != 'x' && TextTools.IsNumber(Conversions.ToString(chIn[1])) == false)
                        {
                            return false;
                        }
                        else if (chIn[1] == 'x')
    ...
    public struct UniPoint
    {
        ...
        public static explicit operator ColorStructs.W32POINT(UniPoint operand)
        {
            return new ColorStructs.W32POINT((int)operand.X, (int)operand.Y);
        }

        public static implicit operator UniPoint(ColorStructs.W32POINT operand)
        {
            return new UniPoint(operand);
        }
        ...
        public UniPoint(ColorStructs.W32POINT p)
        {
            _x = p.x;
            _y = p.y;
        }
    ...
    public struct UniSize
    {
        ...
        public static explicit operator ColorStructs.W32SIZE(UniSize operand)
        {
            return new ColorStructs.W32SIZE((int)operand.cx, (int)operand.cy);
        }

        public static explicit operator UniSize(ColorStructs.W32SIZE operand)
        {
            return new UniSize(operand);
        }
        ...
        public static explicit operator UniSize(string operand)
        {
            ...
            var p = new UniSize();
            p.cx = Conversions.ToDouble(st[0].Trim());
            p.cy = Conversions.ToDouble(st[1].Trim());
            return p;
        }
        ...
        public UniSize(ColorStructs.W32SIZE p)
        {
            cx = p.cx;
            cy = p.cy;
        }
                    ...
                    case "_dx":
                        {
                            ...
                            {
                                if (Conversions.ToDouble(fe.GetValue(obj)) == Width)
                                {
                                    xmatch = true;
                                }
                            }
                    ...
                    case "_dy":
                        {
                            if (fe.FieldType.IsPrimitive)
                            {
                                if (Conversions.ToDouble(fe.GetValue(obj)) == Height)
                                {
                                    ymatch = true;
                                }
                            }
                    ...
                    case "_dx":
                        {
                            ...
                            {
                                if (Conversions.ToDouble(pe.GetValue(obj)) == Width)
                                {
                                    xmatch = true;
                                }
                            }
                    ...
                    case "_dy":
                        {
                            if (pe.PropertyType.IsPrimitive)
                            {
                                if (Conversions.ToDouble(pe.GetValue(obj)) == Height)
                                {
                                    ymatch = true;
                                }
                            }
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public bool Equals(ColorStructs.W32SIZE other)
        {
    ...
    public struct UniRect : INotifyPropertyChanged
    {
        ...
        public UniRect(ColorStructs.W32RECT rectStruct)
        {
        ...
        public static explicit operator ColorStructs.W32RECT(UniRect operand)
        {
            return new ColorStructs.W32RECT() { left = (int)operand._Left, top = (int)operand._Top, right = (int)operand.Right, bottom = (int)operand.Bottom };
        }

        public static implicit operator UniRect(ColorStructs.W32RECT operand)
        {
            return new UniRect(operand);
        }
