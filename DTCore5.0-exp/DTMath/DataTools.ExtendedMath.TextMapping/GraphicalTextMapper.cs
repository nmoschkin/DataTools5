...
namespace DataTools.ExtendedMath.TextMapping
{
    public class CalculatedEventArgs : EventArgs
    {
        ...
        {
            _Start = DateAndTime.Now;
        }

        public void StopTimer()
        {
            _Stop = DateAndTime.Now;
        }
    ...
    public class GraphicalTextMapper : System.Collections.ObjectModel.ObservableCollection<LineSegments>
    {
        ...
        protected Rectangle[] Calculate()
        {
            ...
            CoreCT.Memory.MemPtr mm = bm.Scan0;
        ...
        protected bool CheckRect(Rectangle rc, int cx, int cy, CoreCT.Memory.MemPtr mm)
        {
            int x;
            int y;
            int l;
