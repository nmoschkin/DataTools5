...
namespace DataTools.Interop.Desktop
{
    ...
    public sealed class FontInfo
    {
        ...
        public FontWeight Weight
        {
            get
            {
                return (FontWeight)Conversions.ToInteger(lf.lfWeight);
            }
        }
        ...
        public FontCharSet CharacterSet
        {
            get
            {
                return (FontCharSet)Conversions.ToByte(lf.lfCharSet);
            }
        }
        ...
        public FontPitch Pitch
        {
            get
            {
                return (FontPitch)Conversions.ToInteger(lf.lfPitchAndFamily & 3);
            }
        }
        ...
        public FontFamilies Family
        {
            get
            {
                PInvoke.FontPitchAndFamily v = (PInvoke.FontPitchAndFamily)Conversions.ToByte(lf.lfPitchAndFamily >> 2 << 2);
                switch (v)
                {
                ...
                return (FontFamilies)Conversions.ToInteger(v);
            }
        }
    ...
    public sealed class FontCollection : ICollection<FontInfo>
    {
        ...
        public static FontCollection GetFonts(FontFamilies families = FontFamilies.DontCare, FontPitch pitch = FontPitch.Default, FontCharSet charset = FontCharSet.Default, FontWeight weight = FontWeight.DontCare, object Script = null, object Style = null)
        {
            ...
            {
                wscript = new[] { Conversions.ToString(Script) };
            }
            else if (Script is string[])
            {
            ...
            {
                wstyle = new[] { Conversions.ToString(Style) };
            }
            else if (Style is string[])
            {
                wstyle = (string[])Style;
        ...
        public void Sort(string SortProperty = "Name", SortOrder SortOrder = SortOrder.Ascending)
        {
            ...
            _List.Sort(new Comparison<FontInfo>((a, b) =>
            {
                ...
                string o1;
                string o2;
                o1 = Conversions.ToString(pi.GetValue(a));
                o2 = Conversions.ToString(pi.GetValue(b));
                if (o1 is string)
                {
                    x = string.Compare(o1, o2);
                }
                else if (Operators.CompareString(o1, o2, false) < 0)
                {
                    x = -1;
                }
                else if (Operators.CompareString(o2, o1, false) < 0)
                {
                    x = 1;
                }
