...
namespace DataTools.Interop.Native.Menu
{
    ...
    public class NativeMenuItemCollection : IEnumerable<NativeMenuItem>
    {
        ...
        public NativeMenuItem Insert(int insertAfter, string text, Bitmap bmp, bool fbyPos, IntPtr data)
        {
            ...
            if (bmp is object)
            {
                ...
                mii.hbmpItem = Resources.MakeDIBSection(bmp, ref argbitPtr);
        ...
        {
            return Insert(insertAfter, text, Resources.IconToTransparentBitmap(icon), fbyPos, IntPtr.Zero);
        }
    ...
    public class NativeMenuItem
    {
        ...
        public string Text
        {
            get
            {
                ...
                mii.cch = 0;
                PInvoke.GetMenuItemInfo(hMenu, itemId, false, ref mii);
                mm.Length = (mii.cch + 1) * Strings.Len('A');
                mii.cch += 1;
        ...
        public IntPtr hBitmap
        {
            ...
            set
            {
                ...
                if (mii.hbmpItem != IntPtr.Zero)
                {
                    NativeShell.DeleteObject(mii.hbmpItem);
        ...
        public Icon Icon
        {
            set
            {
                Bitmap = Resources.IconToTransparentBitmap(value);
            }
        }
        ...
        public Bitmap Bitmap
        {
            ...
            set
            {
                ...
                mii.hbmpItem = Resources.MakeDIBSection(value, ref argbitPtr);
        ...
        public MenuItemType ItemType
        {
            get
            {
                ...
                mii.fMask = PInvoke.MIIM_FTYPE;
                PInvoke.GetMenuItemInfo(hMenu, itemId, false, ref mii);
                return (MenuItemType)Conversions.ToInteger(mii.fType & NativeMenuConversion.MenuTypeMask);
            }
